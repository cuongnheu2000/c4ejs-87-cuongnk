...
//ex2
// let newArr = [2,5,6,9,10];
// let i = newArr.length;
// let randomNumber = Math.floor(Math.random()*(i));
// console.log(newArr[randomNumber]);

//ex3
// let quizzes = [
// {
//     ask: 'con kiến có mấy chân?',
//     ans: ['1. 8','2. 6','3. 4', '4. 10'],
//     rightAns: 1
// },
// {
//     ask: 'What sweet food madeby bees using nectar form flowers?',
//     ans: ['1. Bread','2. Honey','3. Sugar', '4. Potent'],
//     rightAns: 4
// },
// {
//     ask: 'which fictional detective lived at 221b Baker Street?',
//     ans: ['1. Watson','2. Sam Spade','3. Scubidu', '4. Sherlock Holmes'],
//     rightAns: 2
// }
// ];
//ex4
// let  lenArr= quizzes.length;
// let randomAsk = Math.floor(Math.random()*(lenArr));
// let ansQuizzez = prompt(`${quizzes[randomAsk].ask} \n  ${quizzes[randomAsk].ans}`);
//ex5
// let arrAns = quizzes[randomAsk].ans;
// if(ansQuizzez == quizzes[randomAsk].rightAns){
//     alert('bravo');
// }
// else{
...
// for(let item in jobData.hits[0].benefits){
//     console.log('-' +jobData.hits[0].benefits[item].benefitValue);
// }
//7
...
// }
// console.log('===============================================================');
// console.log(jobData.hits[1].jobTitle);
// console.log('benefits:');
// for(let item in jobData.hits[1].benefits){
//     console.log('-' +jobData.hits[1].benefits[item].benefitValue);
// }
// console.log('==============================================================');
//8
// console.log('Title: ' +jobData.hits[2].jobTitle);
// console.log(`Salary: ${jobData.hits[2].salaryMax}$`);
// console.log('Location: ' +jobData.hits[2].locations);
// console.log('benefits:');
// for(let item in jobData.hits[2].benefits){
//     console.log('-' +jobData.hits[2].benefits[item].benefitValue);
// }
// console.log('Skills:'); 
// for(let itemskill in jobData.hits[2].skills){
//     console.log('-' +jobData.hits[2].skills[itemskill]);
// }
...
//     const brands = inventory[i];
//     console.log(brands);
//     const nameBrand = brands.brand;
//     console.log(nameBrand);
//     inventoryByBrand[nameBrand].push(brands);
// }
